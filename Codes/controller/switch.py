            ...
            if eth.ethertype == ether_types.ETH_TYPE_IP:
                ...
                if protocol == in_proto.IPPROTO_ICMP:
                    ...
                    match = parser.OFPMatch(eth_type=ether_types.ETH_TYPE_IP,
                                            ...
                                            icmpv4_type=t.type,in_port=in_port,eth_dst=dst,eth_src=src)
                ...
                #  if TCP Protocol
                    ...
                    match = parser.OFPMatch(eth_type=ether_types.ETH_TYPE_IP,
                                            ipv4_src=srcip, ipv4_dst=dstip,
                                            ip_proto=protocol,
                                            tcp_src=t.src_port,tcp_dst=t.dst_port,in_port=in_port,eth_dst=dst, eth_src=src)
                ...
                #  If UDP Protocol
                    ...
                    match = parser.OFPMatch(eth_type=ether_types.ETH_TYPE_IP,
                                            ipv4_src=srcip, ipv4_dst=dstip,
                                            ip_proto=protocol,
                                            udp_src=u.src_port,udp_dst=u.dst_port,in_port=in_port,eth_dst=dst,eth_src=src)
